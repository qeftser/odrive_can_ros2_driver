...
namespace odrive {
    ...
    class ODriveAxis {
        public:
            ODriveAxis(rclcpp::Node * node, std::string axis_name, int axis_can_id, std::string direction);
            double getAxisAngle();
        ...
        private:
            ...
            rclcpp::Subscription<can_msgs::msg::Frame>::SharedPtr received_messages_sub_;
            rclcpp::Publisher<can_msgs::msg::Frame>::SharedPtr sent_messages_pub_;
            rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr target_velocity_sub_;
            rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr output_velocity_pub_;
            rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr axis_angle_pub_;
            rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr axis_velocity_pub_;
            rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr axis_voltage_pub_;
            rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr axis_current_pub_;
            rclcpp::TimerBase::SharedPtr axis_update_timer_;
            ...
            void velocityReceivedMessagesCallback(const std_msgs::msg::Float64& msg);
